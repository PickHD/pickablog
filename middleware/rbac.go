...
func SuperAdminOnlyMiddleware(ctx *fiber.Ctx) error {
	...
	return helper.ResponseFormatter[any](ctx,fiber.StatusForbidden,model.ErrForbiddenAccess,model.ErrForbiddenAccess.Error(),nil,nil)
}

// AuthorOnlyMiddleware responsible to ensure authorized role is author
